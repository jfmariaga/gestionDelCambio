...
return [
    ...
    'attributes' => [
        ...
        'texto' => 'texto',
        'proceso_id' => 'proceso',
        'riesgo_predeterminado_id' => 'riesgo predeterminado',
        'dueno_por_defecto' => 'dueño que revisa',
        'evidencia_por_defecto' => 'evidencia mínima',
        'accion_por_defecto' => 'acción sugerida',
        'fecha' => 'fecha',
        'fecha_requerida' => 'fecha requerida',
        'nombre_cambio' => 'nombre del cambio',
        'solicitante_cargo' => 'solicitante / cargo',
        'area_proceso' => 'área / proceso',
        'tipo_cambio' => 'tipo de cambio',
        'costo_estimado' => 'costo estimado',
        'requiere_comite' => '¿requiere comité?',
